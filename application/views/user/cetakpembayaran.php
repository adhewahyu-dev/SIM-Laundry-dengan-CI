			...
			<div class="card">
			  ...
			  <div class="card-body" id="print">
			  	<table width="1000" border="0" height="500">
			  		<tr>
			  			...
			  			<td>
			  				...
			  				<table>
			  					...
			  					<tr>
			  						<td><h5 class="card-title">Diambil Tgl.   :  <?= longdate_indo($transaksi['tgl_ambil']); ?></h5></td>
			  					</tr>
			  					<tr>
			  		...
			  		<tr>
			  			<td colspan="4"><small class="text-danger pl-3">*Note = Tanda pelunasan pembayaran</small></td>
			  		</tr>
			  		<tr>
			  			<td colspan="3">
			  				...
			  				<table width="950" border="1" class="table table-bordered">
				  				...
				  				<tbody>
				  					...
				  					<tr height="50">
				  						<td colspan="3" align="center"> TERBAYAR </td>
